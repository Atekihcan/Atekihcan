...
As I had mentioned in the [previous post]({% link '11_hash_sum_mismatch_ubuntu_virtualbox' %}), I have been working on setting up a Linux VM to test my upcoming OpenGL tutorial series. As part of that, I  was trying to setup CMake on the VM, so that I can sort out cross platform builds.
...
Feel free to download binaries if you want, from {% link_out "official CMake download page" "https://cmake.org/download/" %}.
...
If you get an error related to OpenSSL, download and install OpenSSL from source. The process is similar to what we are doing with CMake and explained {% link_out "here" "https://stackoverflow.com/a/44789238/4218110" %}.

### BAM! Unexpected Recursion

{% image "https://imgs.xkcd.com/comics/hofstadter.png" "Hofstadter by xkcd" "https://xkcd.com/917/" "Hofstadter by xkcd" %}
