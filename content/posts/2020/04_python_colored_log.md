...
<div class="highlight-green">Note: Please use {% code "logging" %} module as often as you can. It is meant for consistent logging with all other python modules. For my case, I actually needed something to communicate with the application instead of typical logging to the system. If you want a good starting point for using colored logs with {% code "logging" %} module, please have a look at {% link_out "this gist" "https://gist.github.com/joshbode/58fac7ababc700f51e2a9ecdebe563ad" %}.</div>
